...
I am providing you with the {tframe} chart for {stock} stock listed on {xchange}. 
I want a detailed technical analysis of the chart for {tsetup} trading.. 
Please provide general information about the price trends, key technical indicators, and any notable patterns or support/resistance levels in the chart.
""".format(tframe=time_frame, stock=stock_name, xchange=exchange,  tsetup=trade_setup)

input_prompt2 = """
You are a stock market expert. 
I am providing you with the {tframe} chart for {stock} stock listed on {xchange}. 
I want a detailed fundamental analysis of the chart for {tsetup}. 
Please analyze the fundamental aspects of the stock, such as earnings, revenue, and financial ratios, and provide general information about its financial health and outlook.
""".format(tframe=time_frame, stock=stock_name, xchange=exchange,  tsetup=trade_setup)

input_prompt3 = """
You are a stock market expert. 
I am providing you with the {tframe} chart for {stock} stock listed on {xchange}. 
I am looking to analyze the stock for {tsetup} trading. 
Please provide me with the possible entry, target, and stop-loss levels for the given stock and setup, based on your technical analysis of the chart.
""".format(tframe=time_frame, stock=stock_name, xchange=exchange, tsetup=trade_setup)
