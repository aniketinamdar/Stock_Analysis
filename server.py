...
def get_positions():
    ...
    from_time, to_time = prompt_type_value["from_to_func"](prompt_type_value["from"][0], prompt_type_value["to"][0])
    img_byte_obj1 = download_image(sname=stock_name, exch=exchange, inter=interval1, rng_from=from_time, rng_to=to_time, save_path="chart_img1.png")
    from_time, to_time = prompt_type_value["from_to_func"](prompt_type_value["from"][1], prompt_type_value["to"][1])
    img_byte_obj2 = download_image(sname=stock_name, exch=exchange, inter=interval2, rng_from=from_time, rng_to=to_time, save_path="chart_img2.png")
